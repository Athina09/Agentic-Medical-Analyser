  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { opacity: "0.85", filter: "drop-shadow(0 0 24px rgba(34, 197, 94, 0.25))" },
          "50%": { opacity: "1", filter: "drop-shadow(0 0 32px rgba(34, 197, 94, 0.4))" },
        },
        "figure-arise": {
      ...
      animation: {
        ...
        "human-turn": "human-turn 6s ease-in-out infinite",
        "hero-fade-up": "hero-fade-up 0.8s ease-out forwards",
        "glow-pulse": "glow-pulse 4s ease-in-out infinite",
        "figure-arise": "figure-arise 1.4s cubic-bezier(0.22, 1, 0.36, 1) forwards",
      },
    },
  },
